...
/// <summary>
/// PBKDF2/SHA-256 password hashing using only BCL crypto (System.Security.Cryptography) —
/// no third-party package needed. Stored format: "{iterations}.{saltBase64}.{keyBase64}",
